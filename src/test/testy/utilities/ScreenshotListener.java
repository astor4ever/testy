    ...
    public void onTestFailure (ITestResult result) {
            ...
            if (!result.isSuccess()) {
                ...
                try {
                    ...
                    Reporter.log("<a href='" + reportDirectory+destFile.getAbsolutePath().substring(47) + "'> <img src='" + reportDirectory+destFile.getAbsolutePath().substring(47) + "' height='100' width='100'/> </a>");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
